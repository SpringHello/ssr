          ...
          prodItem: [
            {
              ...
              useText: '立即使用',
              detailLink: 'Pecs',
              useLink: this.$store.state.userInfo ? 'host' : 'login',
              ME: true
            },
            {
              title: '镜像服务',
              ...
              useText: '立即使用',
              detailLink: 'Phost',
              useLink: this.$store.state.userInfo ? 'mirror' : 'login',
              ME: false
            },
            {
              title: 'ECS快照',
              ...
              useText: '立即使用',
              detailLink: 'Pecss',
              useLink: this.$store.state.userInfo ? 'snapshot' : 'login',
              ME: false
            },
            {
              title: '裸金属服务器',
          ...
          prodItem: [
            {
              ...
              useText: '立即使用',
              detailLink: 'Pvpc',
              useLink: this.$store.state.userInfo ? 'network' : 'login',
              ME: true
            },
            {
              title: '弹性IP',
            ...
            },
            {
              ...
              useText: '立即使用',
              detailLink: 'Pbalance',
              useLink: this.$store.state.userInfo ? 'bal' : 'login',
              ME: false
            },
            {
              title: 'NAT网关',
          ...
          prodItem: [
            {
              ...
              useText: '立即使用',
              detailLink: 'Pdisk',
              useLink: this.$store.state.userInfo ? 'disk' : 'login',
              ME: true
            },
            {
              title: '云硬盘备份',
          ...
          prodItem: [
            {
              ...
              useLink: this.$store.state.userInfo ? 'firewall' : 'login',
              ME: true
            },
            {
              title: 'DDOS高防IP',
...
// 移入移出动画
.cloudContentFade-enter,
.cloudContentFade-leave-to {
  opacity: 0;
  top: 300px !important;
}

.cloudContentFade-enter-active,
.cloudContentFade-leave-active {
  transition: all 0.5s;
}

// 移入移出动画
.consoleFade-enter,
.consoleFade-leave-to {
  opacity: 0;
  top: 300px !important;
}

.consoleFade-enter-active,
.consoleFade-leave-active {
  transition: all 0.5s;
}
...
.partner-enter-active,
.partner-leave-active {
  transition: all 0.5s;
}

// 移入移出动画
.authorityFade-enter,
.authorityFade-leave-to {
  opacity: 0;
  top: 300px !important;
}

.authorityFade-enter-active,
.authorityFade-leave-active {
  transition: all 0.5s;
}
</style>
